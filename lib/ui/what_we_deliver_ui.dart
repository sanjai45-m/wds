...
class WhatWeDeliverUi extends StatefulWidget {
  const WhatWeDeliverUi({super.key});

  @override
  State<WhatWeDeliverUi> createState() => _WhatWeDeliverUiState();
}

class _WhatWeDeliverUiState extends State<WhatWeDeliverUi> {
  @override
    ...
    return Container(
      ...
      child: Column(
        children: [
          GestureDetector(
            onTap: (){
              ReUse().showEditYourProductDialog(context);
            },
            child: Container(
              margin: EdgeInsets.only(top: 20),
              height: 40,
              width: 180, // Adjusted width to fit content
